	...
	<c:if test="${member ne null}">
		...
		<c:if test="${auth eq 1}">
			<header class="d-flex flex-wrap justify-content-center py-3 mb-3 border-bottom">
				...
				<ul class="nav nav-pills">
					<li class="nav-item"><a class="nav-link text-blue"><b>관리자 페이지</b></a>
					<li class="nav-item"><a href="${path }/admin/memberList.do" class="nav-link">회원목록</a></li>
					<li class="nav-item"><a href="${path }/admin/productList.do" class="nav-link">상품관리</a></li>
					<li class="nav-item"><a href="${path }/admin/orderList.do" class="nav-link">주문관리</a></li>
					<li class="nav-item"><a href="${path }/board/list.do" class="nav-link">문의게시판</a></li>
					<li class="nav-item"><a href="${path }/member/logout.do" class="nav-link">로그아웃</a></li>
				</ul>
   			</header>
