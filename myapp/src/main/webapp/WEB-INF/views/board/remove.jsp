...
<div class="album py-5 bg-light">
	<div class="container">
		<div class="row">
			<div class="col" style="text-align:center;">
				<a href="#" class="align-items-center mb-3 mb-md-0 me-md-auto text-dark text-decoration-none">
		        	<span class="fs-4">문의게시판 - 글 삭제</span>
      			</a>
			</div>
		</div>
		...
		<form id="removeForm" name="removeForm" method="POST" action="${path }/board/removeBoard.do">
			...
			<div class="row" style="margin-bottom: 20px;">
				...
				<div class="col-2" align="right">
					<button type="submit" class="btn btn-outline-primary">글 삭제</button>
				</div>
