	...
	<div class="container">
		...
		<div class="row">
			<div class="col" style="text-align:center;">
				<h4 align="center">상품 삭제</h4>
			</div>
		</div>
		
		<br>

		<form name="productModifyForm" method="POST" action="${path }/admin/productRemove.do" enctype="multipart/form-data">
			<input type="hidden" name="no" id="no" value="${dto.no }">
			<div class="row" style="margin-bottom: 10px;">
				<div class="col-4"></div>
				<label for="productName" class="col-1 col-form-label">상품 이름</label>
				<div class="col-3">
					<input type="text" class="form-control" name="name" id="name" value="${dto.name }" disabled>
				</div>
				<div class="col-4"></div>
			</div>
			...
			<div class="row" style="margin-bottom: 10px;">
				...
				<div class="col-3">
					<input type="number" class="form-control" name="price" id="price" value="${dto.price }" disabled>
				</div>
				<div class="col-4"></div>
			</div>
			...
			<div class="row" style="margin-bottom: 10px;">
				...
				<div class="col-3">
					<textarea class="form-control" name="description" id="description"
						rows="3" style="height: 150px;" disabled>${dto.description }</textarea>
				</div>
				<div class="col-4"></div>
			</div>
			...
			<div class="row" style="margin-bottom: 10px;">
				<div class="col-4"></div>
				<label for="productRegDate" class="form-label col-1">등록일</label>
				<div class="col-3">
					<input type="text" class="form-control" name="regDate" id="regDate" value="${dto.regDate }" disabled>
				</div>
				<div class="col-4"></div>
			</div>
