	...
	<div class="container">
			...
			<c:when test="${!empty orderDetailList}">
				<c:forEach var="orderDetailList" items="${orderDetailList}" varStatus="status">
					<div class="row">
						...
						<div class="col-1" align="center">
							<span>${orderDetailList.productAmount }</span>
						</div>
						<div class="col-1" align="center">
							<fmt:formatNumber type="number" pattern="###,###,###,###,###,###" value="${orderDetailList.productPrice / orderDetailList.productAmount }" />
						</div>
						<div class="col-1" align="center">
							<span>${orderDetailList.productPrice }</span>
						</div>
						<div class="col-3" align="center"></div>
					</div>
					<div class="row">
		...
		<div class="row" style="margin-bottom: 20px;">
				...
				<div class="col-2" align="center">
					<button type="button" onclick="location.href='${path }/member/myOrder.do'" class="btn btn-outline-success">주문 목록</button>
				</div>
				<div class="col-5"></div>
		</div>
