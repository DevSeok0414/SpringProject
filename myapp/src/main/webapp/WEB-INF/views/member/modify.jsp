...
<div class="album py-5 bg-light">
	<div class="container">
		...
		<form name="modifyForm" id="modifyForm" method="POST" action="${path }/member/modifyMember.do">
			...
			<div class="row" style="margin-bottom: 10px;">
				...
				<div class="col-3">
					<input type="text" class="form-control" name="name" id="name" value="${member.name }" disabled>
				</div>
				<div class="col-4"></div>
			</div>
			...
			<div class="row" style="margin-bottom: 10px;">
				...
				<div class="col-3">
					<input type="text" class="form-control" name="phone" id="phone" value="${member.phone }" required>
				</div>
				<div class="col-4"></div>
			</div>
			...
			<div class="row" style="margin-bottom: 10px;">
				...
				<div class="col-7">
					<input type="text" id="address1" name="address1" placeholder="우편번호" style="width:30%; margin-bottom: 10px;" value="${dto.address1 }">
					<input type="button" onclick="sample4_execDaumPostcode()" value="우편번호 찾기"><br>
					<input type="text" id="address2" name="address2" placeholder="도로명주소" style="width:50%; margin-bottom: 10px;" value="${dto.address2 }">
					<input type="text" id="address3" name="address3" placeholder="지번주소" style="width:50%; margin-bottom: 10px;" value="${dto.address3 }" required><br>
					<span id="guide" style="color:#999;display:none"></span>
					<input type="text" id="address4" name="address4" placeholder="상세주소" style="width:30%; margin-bottom: 10px;" value="${dto.address4 }">
					<input type="text" id="address5" name="address5" placeholder="참고항목" style="width:30%; margin-bottom: 10px;" value="${dto.address5 }">
				</div>
			</div>
			...
			<div class="row" style="margin-bottom: 10px;">
				...
				<div class="col-2" align="right" style="margin-right: -5px;">
					<button type="button" onclick="modify()" class="btn btn-outline-primary">정보 수정</button>
				</div>
				<div class="col-2" align="left" style="margin-right: -3px;">
					<button type="button" onclick="location.href='${path }/member/myPage.do'" class="btn btn-outline-success">나의 정보</button>
				</div>
				<div class="col-3"></div>
			</div>
			
			<input type="hidden" id="hiddenPassword" value="${member.password }">
