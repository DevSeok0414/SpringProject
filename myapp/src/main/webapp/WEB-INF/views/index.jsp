	...
	<div class="row g-4 py-5">
		...
		<div class="col-4 d-flex align-items-start">
			<div>
				...
				<p>
					국비학원 수료 후 2주간 Spring Framework를 이용하여 간단한 쇼핑몰을 만들었습니다.
		...
		<div class="col-8">
			<div>
				...
				<ol>
					...
					<li style="margin-bottom:15px;">Ajax를 활용해야 할 때가 많다는 것을 알게되었습니다.
						Ajax를 써야할 때면 직접 찾으면서 배우면서 적용시켜야 했던 관계로 오랜 시간 막혀있기도 했었습니다. 
						특히 장바구니에 담긴 물품을 체크하면 총 금액이 바뀌는 기능은 몇 시간을 써가며 시행착오를 겪고나서야 구현할 수 있었습니다.
						자바와는 다르게 움직이는 클라이언트 사이드 렌더링이 신기하기도 했고 이 방식이 강력한 면도 있다는 것을 느꼈습니다.
						추후 Ajax에 대해서 더 많이 공부를 해야 할 필요성을 강하게 느꼈습니다.
					</li>
					<li style="margin-bottom:15px;">기본적인 기능을 구현하는 것 외에 공백 처리, null값 처리 등 예외적인 상황에 대한 처리를 해야할 것이 많다는 것을 느꼈고
